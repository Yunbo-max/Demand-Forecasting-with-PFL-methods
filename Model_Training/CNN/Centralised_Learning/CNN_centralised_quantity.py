...
# @Last Modified time: 2024-07-23 09:35:12
# -*- coding = utf-8 -*-
...
wandb.init(project="ISMM_CNN_centralised_quantity_with_validation")
...
class SalesPredictionCNN(nn.Module):
    def __init__(self):
        ...
        self.fc1 = nn.Linear(16 * 15, 240)  # Adjusted the shape here
