...
# @Last Modified time: 2024-10-05 21:51:56
# -*- coding = utf-8 -*-
...
for sheet_names in sheet_name:
    ...
    config = {"region": value}
    with wandb.init(project='ISMM_CNN_local_quantity_with_validation', config=config) as run:
